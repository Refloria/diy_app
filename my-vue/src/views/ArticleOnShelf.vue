<template>
  <div>
    <div class="table-button-bar">
      <el-button @click="handleMultipleArticleOffShelf">批量下架</el-button>
    ...
    <el-table
      ...
      <el-table-column fixed="right" label="操作" width="90">
        <template #default="scope">
          ...
          <el-button type="text" size="small" @click="handleArticleOffShelf([scope.row])">下架</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
export default {
  ...
  methods: {
    ...
    searchArticle () {
      this.searchWord = this.inputSearchWord.trim()
    ...
    handleArticleOffShelf (rows) {
      ...
      this.$axios.post('/api/takeArticleOffShelf', { articles: articleIdList })
        .then(resp => {
    ...
    handleMultipleArticleOffShelf () {
      this.handleArticleOffShelf(this.multipleSelection)
    },
    clearSelection () {
